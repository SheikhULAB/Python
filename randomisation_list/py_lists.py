states_of_america = [
    ...
    "Colorado", "North Dakota", "South Dakota", "Florida",
    "Washington", "Idaho", "Montana", "Wyoming", "Utah", "Oklahoma",
    "New Mexico", "Arizona", "Alaska", "Hawaii"
]

print(states_of_america)

states_of_america.append("Yaminland")

print(states_of_america)

states_of_america.extend(["Angelaland", "Banglaland"])
print(states_of_america)